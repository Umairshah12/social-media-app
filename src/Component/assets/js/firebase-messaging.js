!(function (e, t) {
  ...
  try {
    (function () {
      ...
      function f(e, t, n) {
        ...
        return (
          ...
          Error.captureStackTrace &&
            Error.captureStackTrace(t, v.prototype.create),
          t
        );
      }
      var v =
        ...
        n.forEach(function (n) {
          n in t.prototype &&
            (e.prototype[n] = function () {
              return (
                (e = this[r]),
                (t = k(e, n, arguments)).then(function (e) {
      ...
      S(_, "_index", ["name", "keyPath", "multiEntry", "unique"]),
        I(_, "_index", IDBIndex, [
          "get",
          "getKey",
          "getAll",
        ...
        C(_, "_index", IDBIndex, ["openCursor", "openKeyCursor"]),
        S(P, "_cursor", ["direction", "key", "primaryKey", "value"]),
        ...
        S(D, "_store", ["name", "keyPath", "indexNames", "autoIncrement"]),
        I(D, "_store", IDBObjectStore, [
          "put",
          "add",
          "delete",
          "clear",
        ...
        C(D, "_store", IDBObjectStore, ["openCursor", "openKeyCursor"]),
        T(D, "_store", IDBObjectStore, ["deleteIndex"]),
        (j.prototype.objectStore = function () {
          return new D(this._tx.objectStore.apply(this._tx, arguments));
        }),
        S(j, "_tx", ["objectStoreNames", "mode"]),
        T(j, "_tx", IDBTransaction, ["abort"]),
        (M.prototype.createObjectStore = function () {
          return new D(this._db.createObjectStore.apply(this._db, arguments));
        }),
        S(M, "_db", ["name", "version", "objectStoreNames"]),
        T(M, "_db", IDBDatabase, ["deleteObjectStore", "close"]),
        (O.prototype.transaction = function () {
          return new j(this._db.transaction.apply(this._db, arguments));
        }),
        S(O, "_db", ["name", "version", "objectStoreNames"]),
        T(O, "_db", IDBDatabase, ["close"]),
      ...
      var x = "0.4.20",
        ...
        B = 36e5,
        L =
          (((L = {})["missing-app-config-values"] =
            'Missing App configuration value: "{$valueName}"'),
          (L["not-registered"] = "Firebase Installation is not registered."),
          (L["installation-not-found"] = "Firebase Installation not found."),
          (L["request-failed"] =
            '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"'),
          (L["app-offline"] =
            "Could not process request. Application offline."),
          (L["delete-pending-registration"] =
      ...
      function te(e, t) {
        ...
        ne(n, t),
          (e = n),
          (n = t),
          (t = ie()) && t.postMessage({ key: e, fid: n }),
          oe();
      }
      function ne(e, t) {
        var n,
        ...
        if (i)
          try {
            for (var o = l(i), s = o.next(); !s.done; s = o.next())
              (0, s.value)(t);
          } catch (e) {
            n = { error: e };
          } finally {
          ...
          return h(this, function (e) {
            switch (e.label) {
              ...
              case 1:
                return (
                  (r = e.sent()),
                  (n = r.transaction(ce, "readwrite")),
                  [4, (r = n.objectStore(ce)).get(t)]
                );
              case 2:
        ...
        return d(this, void 0, void 0, function () {
          ...
          return h(this, function (e) {
            switch (e.label) {
              ...
              case 7:
                return (
                  e.sent(), !o || (i && i.fid === o.fid) || te(s, o.fid), [2, o]
                );
            }
          });
        });
            ...
            switch (e.label) {
              case 0:
                return [
                  4,
                  he(i, function (e) {
                    (e = be(e || { fid: Q(), registrationStatus: 0 })),
                      (e = (function (e, t) {
                        {
      ...
      function me(e) {
        return he(e, function (e) {
          if (!ke(e)) throw V.create("not-registered");
          var t = e.authToken;
          return 1 === (t = t).requestStatus && t.requestTime + N < Date.now()
        ...
        return (
          ...
          function () {
            ...
            (t = r),
              (n = X((e = i))),
              (e = ee.get(n)) &&
                (e.delete(t), 0 === e.size && ee.delete(n), oe());
          }
        );
      }
      function Ce(e) {
      ...
      (se = t.default).INTERNAL.registerComponent(
        new y(
          "installations",
          function (e) {
                      ...
                      switch (e.label) {
                        ...
                        case 1:
                          return (
                            ...
                            (t.registrationPromise || we(r)).catch(
                              console.error
                            ),
                            [2, n.fid]
                          );
        ...
        se.registerVersion("@firebase/installations", x);
      var _e,
        L =
          (((L = {})["missing-app-config-values"] =
            'Missing App configuration value: "{$valueName}"'),
          (L["only-available-in-window"] =
            "This method is available in a Window context."),
          (L["only-available-in-sw"] =
            "This method is available in a service worker context."),
          (L["permission-default"] =
            "The notification permission was not granted and dismissed instead."),
          (L["permission-blocked"] =
            "The notification permission was not granted and blocked instead."),
          (L["unsupported-browser"] =
            "This browser doesn't support the API's required to use the firebase SDK."),
          (L["failed-service-worker-registration"] =
            "We are unable to register the default service worker. {$browserErrorMessage}"),
          (L["token-subscribe-failed"] =
            "A problem occurred while subscribing the user to FCM: {$errorInfo}"),
          (L["token-subscribe-no-token"] =
            "FCM returned no token when subscribing the user to push."),
          (L["token-unsubscribe-failed"] =
            "A problem occurred while unsubscribing the user from FCM: {$errorInfo}"),
          (L["token-update-failed"] =
            "A problem occurred while updating the user from FCM: {$errorInfo}"),
          (L["token-update-no-token"] =
            "FCM returned no token when updating the user to push."),
          (L["use-sw-after-get-token"] =
            "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used."),
          (L["invalid-sw-registration"] =
            "The input to useServiceWorker() must be a ServiceWorkerRegistration."),
          (L["invalid-bg-handler"] =
            "The input to setBackgroundMessageHandler() must be a function."),
          (L["invalid-vapid-key"] = "The public VAPID key must be a string."),
          (L["use-vapid-key-after-get-token"] =
      ...
      ((L = _e = _e || {}).PUSH_RECEIVED = "push-received"),
                          ...
                          switch (e.label) {
                            case 0:
                              return i.oldVersion < 2
                                ...
                                ? [
                                    4,
                                    (r = i.transaction.objectStore(Ne))
                                      .index("fcmSenderId")
                                      .get(s),
                                  ]
                                : [2];
                            ...
                            case 2:
                              ...
                              } else (3 === i.oldVersion || 4 === i.oldVersion) && (o = { token: (n = t).fcmToken, createTime: n.createTime, subscriptionOptions: { auth: Ee(n.auth), p256dh: Ee(n.p256dh), endpoint: n.endpoint, swScope: n.swScope, vapidKey: Ee(n.vapidKey) } });
                              return [2];
                          }
                        });
                      });
            ...
            switch (e.label) {
              ...
              case 4:
                if ((t = e.sent()).error)
                  throw (
                    ((n = t.error.message),
                    Pe.create("token-unsubscribe-failed", { errorInfo: n }))
                  );
                return [3, 6];
              case 5:
                throw (
      ...
      var et =
        (Object.defineProperty(tt.prototype, "app", {
          get: function () {
        ...
        (tt.prototype.setBackgroundMessageHandler = function (e) {
          if (
        ...
        (tt.prototype.onBackgroundMessage = function (e) {
          var t = this;
          return (
              ...
              switch (e.label) {
                case 0:
                  return this.vapidKey
                    ? [3, 2]
                    : [4, Fe(this.firebaseDependencies)];
                case 1:
                  (t = e.sent()),
                    (this.vapidKey =
                      null !==
        ...
        (tt.prototype.useServiceWorker = function () {
          throw Pe.create("only-available-in-window");
        }),
        (tt.prototype.onMessage = function () {
          throw Pe.create("only-available-in-window");
        }),
        (tt.prototype.onTokenRefresh = function () {
          throw Pe.create("only-available-in-window");
        }),
        (tt.prototype.onPush = function (c) {
          return d(this, void 0, void 0, function () {
            var s, a, u;
            return h(this, function (e) {
              switch (e.label) {
                    ...
                    ? [
                        ...
                        (function (e, t) {
                          ...
                          (t.isFirebaseMessaging = !0),
                            (t.messageType = _e.PUSH_RECEIVED);
                          try {
                            for (
                              var i = l(e), o = i.next();
                              !o.done;
        ...
        (tt.prototype.onSubChange = function (n) {
          var r;
          return d(this, void 0, void 0, function () {
            var t;
            return h(this, function (e) {
              switch (e.label) {
                case 0:
                  return n.newSubscription
                    ? [3, 2]
                    : [4, Ye(this.firebaseDependencies, self.registration)];
                case 1:
                  return e.sent(), [2];
                case 2:
        ...
        (tt.prototype.onNotificationClick = function (s) {
          var a;
          return d(this, void 0, void 0, function () {
            var t, n, r, i, o;
            return h(this, function (e) {
              switch (e.label) {
                          ...
                          var t,
                            n =
                              null !==
                                ...
                                : n.click_action;
                          if (n) return n;
                          return Qe(e.data) ? self.location.origin : null;
                        })(t))
                ...
                case 6:
                  return o
                    ? ((t.messageType = _e.NOTIFICATION_CLICKED),
                      (t.isFirebaseMessaging = !0),
                      [2, o.postMessage(t)])
                    : [2];
              }
      ...
      var rt =
        (Object.defineProperty(it.prototype, "app", {
          get: function () {
            return this.firebaseDependencies.app;
          },
          enumerable: !1,
        ...
        (it.prototype.messageEventListener = function (i) {
          return d(this, void 0, void 0, function () {
            var n, r;
            return h(this, function (e) {
              switch (e.label) {
                case 0:
                  return (n = i.data).isFirebaseMessaging
                    ? (this.onMessageCallback &&
                        n.messageType === _e.PUSH_RECEIVED &&
        ...
        (it.prototype.getVapidKey = function () {
          return this.vapidKey;
        }),
        (it.prototype.getSwReg = function () {
          return this.swRegistration;
        }),
        (it.prototype.getToken = function (t) {
          return d(this, void 0, void 0, function () {
            return h(this, function (e) {
              switch (e.label) {
                case 0:
        ...
        (it.prototype.updateVapidKey = function (t) {
          return d(this, void 0, void 0, function () {
            return h(this, function (e) {
              return (
                t ? (this.vapidKey = t) : this.vapidKey || (this.vapidKey = De),
                [2]
              );
            });
          });
        }),
        (it.prototype.updateSwReg = function (t) {
          return d(this, void 0, void 0, function () {
            return h(this, function (e) {
              switch (e.label) {
                case 0:
        ...
        (it.prototype.registerDefaultSw = function () {
          return d(this, void 0, void 0, function () {
            var t;
            return h(this, function (e) {
              switch (e.label) {
            ...
            return h(this, function (e) {
              switch (e.label) {
                ...
                case 2:
                  return [
                    2,
                    Ye(this.firebaseDependencies, this.swRegistration),
                  ];
              }
            });
          });
        ...
        (it.prototype.useServiceWorker = function (e) {
        ...
        (it.prototype.onMessage = function (e) {
          var t = this;
          return (
        ...
        (it.prototype.setBackgroundMessageHandler = function () {
          throw Pe.create("only-available-in-sw");
        }),
        (it.prototype.onBackgroundMessage = function () {
          throw Pe.create("only-available-in-sw");
        }),
        (it.prototype.onTokenRefresh = function () {
          return function () {};
        }),
        (it.prototype.logEvent = function (n, r) {
          return d(this, void 0, void 0, function () {
            var t;
            return h(this, function (e) {
              switch (e.label) {
          ...
          function (e) {
            var t = e.getProvider("app").getImmediate(),
              e = {
                ...
                appConfig: (function (e) {
                  var t, n;
                  if (!e || !e.options) throw ot("App Configuration Object");
                  if (!e.name) throw ot("App Name");
                  var r = e.options;
                  try {
                    for (
                      var i = l([
            ...
            if (!st()) throw Pe.create("unsupported-browser");
            return new (self && "ServiceWorkerGlobalScope" in self ? et : rt)(
              e
            );
          },
          "PUBLIC"
